...
// First, we read the keyboard config into an array
var keyboardList = require('./keyboards');
...
console.log('vendorId', keyboardList[keyboard].vendorId);
console.log('productId', keyboardList[keyboard].productId);
...
var device = new hid.HID(keyboardList[keyboard].vendorId, keyboardList[keyboard].productId);
